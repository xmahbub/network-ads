        ...
        <tbody>
            ...
            <?php if ($this->options['strict'] || (is_array($t->aEntitiesData)  || is_object($t->aEntitiesData))) foreach($t->aEntitiesData as $e) {?><tr class="<?php echo htmlspecialchars($e['htmlclass']);?>">
                <td class="<?php echo htmlspecialchars($e['nameclass']);?>" nowrap="nowrap">
                    ...
                    <?php if ($this->options['strict'] || (isset($t) && method_exists($t, 'entityLink'))) if ($t->entityLink($e['prefix'])) { ?><a href="<?php if ($this->options['strict'] || (isset($t) && method_exists($t, 'entityLink'))) echo htmlspecialchars($t->entityLink($e['prefix']));?>&<?php echo htmlspecialchars($e['linkparams']);?>"><?php } else {?><span><?php }?>
                    ...
                    <?php if ($this->options['strict'] || (isset($t) && method_exists($t, 'entityLink'))) if ($t->entityLink($e['prefix'])) { ?></a><?php } else {?></span><?php }?>
